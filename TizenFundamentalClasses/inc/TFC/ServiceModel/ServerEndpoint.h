 ...
 *
 *    ServiceModel/ServerEndpoint.h
 *
 * Abstract classes to develop service server endpoint.
 *
...
protected:
	...
	struct EventHandlerClosure : ObjectClass
	{
		...
		void EventHandlerFunc(T* source, TArg value)
		{
			...
			dlog_print(DLOG_DEBUG, "TFC-RPC-EVENT", "Event is raised in here: %s", eventRef.eventName.c_str());
